...
type Args struct {
	Entity string         `json:"entity" jsonschema:"chart | currency | metadata"`
	Query  map[string]any `json:"query,omitempty" jsonschema:"optional match map e.g. {\"id\":1} for load, omit for list"`
}

func registerTools(server *mcp.Server, client *sdk.KekkaiCurrencySDK) {
	mcp.AddTool(server, &mcp.Tool{
		Name: "kekkai-currency_list",
		Description: "List records from KekkaiCurrency. " +
	...
	mcp.AddTool(server, &mcp.Tool{
		Name: "kekkai-currency_load",
		Description: "Load a single record from KekkaiCurrency. " +
...
func runOp(client *sdk.KekkaiCurrencySDK, op string, args Args) (*mcp.CallToolResult, any, error) {
...
func entityFor(client *sdk.KekkaiCurrencySDK, name string) (sdk.KekkaiCurrencyEntity, error) {
