// Command KekkaiCurrency-mcp is an MCP server exposing the KekkaiCurrency
// SDK as MCP tools.
//
// Two tools are registered:
//
//	KekkaiCurrency_list  — list records of an entity
//	KekkaiCurrency_load  — load a single record of an entity
//
