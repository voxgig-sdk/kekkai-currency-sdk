...
describe("CurrencyDirect", function()
  it("should direct-load-currency", function()
    local setup = currency_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-currency", setup.live and "live" or "unit")
