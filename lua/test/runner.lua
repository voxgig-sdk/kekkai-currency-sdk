...
function runner.env_override(m)
  local live = runner.getenv("KEKKAICURRENCY_TEST_LIVE")
  local override = runner.getenv("KEKKAICURRENCY_TEST_OVERRIDE")
  ...
  local explain = runner.getenv("KEKKAICURRENCY_TEST_EXPLAIN")
