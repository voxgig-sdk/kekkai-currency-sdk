...
function runner.env_override(m)
  local live = runner.getenv("KEKKAI_CURRENCY_TEST_LIVE")
  local override = runner.getenv("KEKKAI_CURRENCY_TEST_OVERRIDE")
  ...
  local explain = runner.getenv("KEKKAI_CURRENCY_TEST_EXPLAIN")
