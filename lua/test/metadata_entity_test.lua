...
describe("MetadataEntity", function()
  ...
  it("should run basic flow", function()
    ...
    if setup.synthetic_only then
      pending("live entity test uses synthetic IDs from fixture — set KEKKAICURRENCY_TEST_METADATA_ENTID JSON to run live")
      return
    end
...
function metadata_basic_setup(extra)
  ...
  local entid_env_raw = os.getenv("KEKKAICURRENCY_TEST_METADATA_ENTID")
  ...
  local live = env["KEKKAICURRENCY_TEST_LIVE"] == "TRUE"
  return {
    client = client,
    data = entity_data,
