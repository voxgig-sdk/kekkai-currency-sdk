...
local KekkaiCurrencySDK = {}
KekkaiCurrencySDK.__index = KekkaiCurrencySDK
...
KekkaiCurrencySDK._make_feature = _make_feature


function KekkaiCurrencySDK.new(options)
  local self = setmetatable({}, KekkaiCurrencySDK)
  self.mode = "live"
  self.features = {}
  self.options = nil
...
function KekkaiCurrencySDK:options_map()
...
function KekkaiCurrencySDK:get_utility()
  return Utility.copy(self._utility)
end


function KekkaiCurrencySDK:get_root_ctx()
  return self._rootctx
end


function KekkaiCurrencySDK:prepare(fetchargs)
...
function KekkaiCurrencySDK:direct(fetchargs)
...
-- by passing it.
function KekkaiCurrencySDK:_raw_request(fetchargs)
  local utility = self._utility
...
function KekkaiCurrencySDK:graphql(query, variables, ctrl)
  ...
  if type(errors) == "table" and 0 < #errors then
    ...
    res.ok = false
    res.err = "KekkaiCurrencySDK: graphql: " .. msg
    res.graphql = errors
  end
...
function KekkaiCurrencySDK.test(testopts, sdkopts)
  sdkopts = sdkopts or {}
  ...
  local sdk = KekkaiCurrencySDK.new(sdkopts)
  sdk.mode = "test"
