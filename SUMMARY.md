...
Results: Successfully generated chart data.

SDK operations: `list`.

### Currency

Results: Successfully retrieved currency rate.
...
Results: Successfully retrieved metadata.
...
| --- | --- | --- | --- |
| Chart | `list` | `GET /api/getChart` | See reference |
| Currency | `load` | `GET /api/getRate` | See reference |
| Metadata | `list` | `GET /api/metadata` | See reference |

## Connect to the API

- Production server: `https://api.kekkai.redume.su`
...
- `kekkai-currency_list`: List records for an entity. Supported entities: `chart`, `metadata`.
- `kekkai-currency_load`: Load one record for an entity. Supported entities: `currency`.
