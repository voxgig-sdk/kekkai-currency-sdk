...
func registerSDKWords(r *eng.Registry, client *sdk.KekkaiCurrencySDK) {
...
func runOp(client *sdk.KekkaiCurrencySDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
