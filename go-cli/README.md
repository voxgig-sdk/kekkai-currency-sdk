...
AQL-driven CLI and REPL for the KekkaiCurrency SDK. Positional arguments are
...
```sh
go build -o kekkai-currency-cli ./...
```
...
./kekkai-currency-cli load 1 chart
./kekkai-currency-cli load '{id:1}' chart
