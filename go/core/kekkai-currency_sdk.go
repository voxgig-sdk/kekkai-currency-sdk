...
func (sdk *KekkaiCurrencySDK) OptionsMap() map[string]any {
...
func (sdk *KekkaiCurrencySDK) GetUtility() *Utility {
	return CopyUtility(sdk.utility)
}

func (sdk *KekkaiCurrencySDK) GetRootCtx() *Context {
	return sdk.rootctx
}

func (sdk *KekkaiCurrencySDK) Prepare(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *KekkaiCurrencySDK) Direct(fetchargs map[string]any) (map[string]any, error) {
...
func (sdk *KekkaiCurrencySDK) opAllowed(op string) bool {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return strings.Contains(allowOp, op)
}

func (sdk *KekkaiCurrencySDK) opDenied(op string) map[string]any {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return map[string]any{
		"ok": false,
		"err": fmt.Errorf("KekkaiCurrencySDK: %s: operation not allowed by"+
...
// gate by passing it.
func (sdk *KekkaiCurrencySDK) rawRequest(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *KekkaiCurrencySDK) Graphql(
	...
	if 0 < len(errors) {
		...
		res["ok"] = false
		res["err"] = fmt.Errorf("KekkaiCurrencySDK: graphql: %s", msg)
		res["graphql"] = errors
	}
...
func TestSDK(testopts map[string]any, sdkopts map[string]any) *KekkaiCurrencySDK {
	...
	sdk := NewKekkaiCurrencySDK(sdkopts)
	sdk.Mode = "test"
