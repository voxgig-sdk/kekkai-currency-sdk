...
func TestChartEntity(t *testing.T) {
	...
	t.Run("basic", func(t *testing.T) {
		...
		if setup.syntheticOnly {
			t.Skip("live entity test uses synthetic IDs from fixture — set KEKKAI_CURRENCY_TEST_CHART_ENTID JSON to run live")
			return
		}
		client := setup.client
...
func chartBasicSetup(extra map[string]any) *entityTestSetup {
	...
	entidEnvRaw := os.Getenv("KEKKAI_CURRENCY_TEST_CHART_ENTID")
	...
	idmapResolved := core.ToMapAny(env["KEKKAI_CURRENCY_TEST_CHART_ENTID"])
