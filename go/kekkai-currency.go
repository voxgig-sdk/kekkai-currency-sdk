...
// instead of `sdk.NewKekkaiCurrencySDK(nil)` / `sdk.TestSDK(nil, nil)`
// for the common no-options case.
func New() *KekkaiCurrencySDK  { return NewKekkaiCurrencySDK(nil) }
func Test() *KekkaiCurrencySDK { return TestSDK(nil, nil) }
