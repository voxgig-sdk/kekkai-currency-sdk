...
// KekkaiCurrency SDK idempotency feature
...
class KekkaiCurrencyIdempotencyFeature extends KekkaiCurrencyBaseFeature
{
    ...
    private function _mutating(KekkaiCurrencyContext $ctx): bool
    {
