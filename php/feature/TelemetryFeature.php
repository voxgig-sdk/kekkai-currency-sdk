...
// KekkaiCurrency SDK telemetry feature
...
class KekkaiCurrencyTelemetryFeature extends KekkaiCurrencyBaseFeature
{
    ...
    private function _close(KekkaiCurrencyContext $ctx, bool $ok): void
    {
