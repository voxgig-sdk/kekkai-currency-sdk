...
// KekkaiCurrency SDK proxy feature
...
class KekkaiCurrencyProxyFeature extends KekkaiCurrencyBaseFeature
{
    ...
    public function init(KekkaiCurrencyContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (KekkaiCurrencyContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
