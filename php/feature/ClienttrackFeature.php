...
// KekkaiCurrency SDK clienttrack feature
...
class KekkaiCurrencyClienttrackFeature extends KekkaiCurrencyBaseFeature
{
    ...
    public function PostConstruct(KekkaiCurrencyContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'KekkaiCurrency-SDK';
