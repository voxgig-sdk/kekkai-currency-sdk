...
// KekkaiCurrency SDK debug feature
...
class KekkaiCurrencyDebugFeature extends KekkaiCurrencyBaseFeature
{
    ...
    private function _finish(KekkaiCurrencyContext $ctx, bool $ok): void
    {
