...
// KekkaiCurrency SDK metrics feature
...
class KekkaiCurrencyMetricsFeature extends KekkaiCurrencyBaseFeature
{
    ...
    private function _record(KekkaiCurrencyContext $ctx, bool $ok): void
    {
