...
// KekkaiCurrency SDK struct utility test
//
...
class StructUtilityTest extends TestCase
{
    ...
    {
        if (self::$run === null) {
            $runner = KekkaiCurrencyOmni::makeStructRunner(
        ...
        $this->runsection(
            ...
            function ($input) {
                ...
                if (is_object($store) && $haspath && Struct::undef() !== $val) {
                    ...
                    if (json_encode(KekkaiCurrencyOmni::structfix($now, Struct::undef()))
                        !== json_encode(KekkaiCurrencyOmni::structfix($val, Struct::undef()))) {
