...
// KekkaiCurrency SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (KekkaiCurrencySDK::test)
...
{
    private const SDK_CLASS = 'KekkaiCurrencySDK';
    ...
    private const SDK_BASE = 'kekkaicurrency_sdk';
    ...
    public function test_php_examples_run_offline(): void
    {
        $ran = 0;
        $failures = [];
        $sdk = __DIR__ . '/../kekkaicurrency_sdk.php';
        foreach ($this->phpBlocks() as $blk) {
