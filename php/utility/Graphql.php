...
// KekkaiCurrency SDK utility: graphql
//
...
class KekkaiCurrencyGraphql
{
    ...
    // equivalent.
    public static function body(KekkaiCurrencyContext $ctx): mixed
    {
    ...
    public static function errors(KekkaiCurrencyContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
