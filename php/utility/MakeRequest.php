...
// KekkaiCurrency SDK utility: make_request

require_once __DIR__ . '/../core/Response.php';
require_once __DIR__ . '/../core/Result.php';

class KekkaiCurrencyMakeRequest
{
    public static function call(KekkaiCurrencyContext $ctx): array
    {
        ...
        if ($fetch_err) {
            ...
            $response = new KekkaiCurrencyResponse(['err' => $ctx->make_error('request_no_response', 'response: undefined')]);
        } elseif (is_array($fetched)) {
            $response = new KekkaiCurrencyResponse($fetched);
        } else {
