...
// KekkaiCurrency SDK utility: make_options

class KekkaiCurrencyMakeOptions
{
    ...
    public static function call(KekkaiCurrencyContext $ctx): array
    {
        ...
        //
        // `KekkaiCurrencySchema::optspec()` is built from the model:
        ...
        $optspec = KekkaiCurrencySchema::optspec();
