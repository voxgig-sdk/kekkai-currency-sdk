# KekkaiCurrency PHP SDK



The PHP SDK for the KekkaiCurrency API — an entity-oriented client using PHP conventions.
...
```
php/
├── kekkaicurrency_sdk.php          -- Main SDK class
...
The main class (`kekkaicurrency_sdk.php`) exports the SDK class
