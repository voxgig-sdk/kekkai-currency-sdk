# KekkaiCurrency TypeScript SDK



The TypeScript SDK for the KekkaiCurrency API — a type-safe, entity-oriented client with full async/await support.

The API is exposed as capitalised, semantic **Entities** — e.g.
`client.Chart()` — each with a small set of operations (`list`, `load`)
...
| `tester(testopts?, sdkopts?)` | `KekkaiCurrencySDK` | Create a test-mode client instance. |

#### Static methods

| Method | Returns | Description |
| --- | --- | --- |
| `KekkaiCurrencySDK.test(testopts?, sdkopts?)` | `KekkaiCurrencySDK` | Create a test-mode client. |
...
| `client` | `client(): KekkaiCurrencySDK` | Return the parent SDK client. |
...
kekkai-currency/
├── src/
│   ├── KekkaiCurrencySDK.ts        # Main SDK class
