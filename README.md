...
| --- | --- | --- |
| TypeScript | `@voxgig-sdk/kekkai-currency` | `npm install @voxgig-sdk/kekkai-currency` |
| Python | `voxgig-sdk-kekkai-currency` | `pip install voxgig-sdk-kekkai-currency` |
| PHP | `voxgig-sdk/kekkai-currency` | `composer require voxgig-sdk/kekkai-currency` |
| Golang | `github.com/voxgig-sdk/kekkai-currency-sdk/go` | `go get github.com/voxgig-sdk/kekkai-currency-sdk/go` |
| Ruby | `voxgig-sdk-kekkai-currency` | `gem install voxgig-sdk-kekkai-currency` |
| Lua | `voxgig-sdk-kekkai-currency` | `luarocks install voxgig-sdk-kekkai-currency` |
