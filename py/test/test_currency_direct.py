...
class TestCurrencyDirect:
    ...
    def test_should_direct_load_currency(self):
        setup = _currency_direct_setup({"id": "direct01"})
        _skip, _reason = runner.is_control_skipped("direct", "direct-load-currency", "live" if setup["live"] else "unit")
        if _skip:
