...
class KekkaiCurrencyTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = KekkaiCurrencyTestRunner.getenv("KEKKAICURRENCY_TEST_LIVE")
        override = KekkaiCurrencyTestRunner.getenv("KEKKAICURRENCY_TEST_OVERRIDE")
        ...
        explain = KekkaiCurrencyTestRunner.getenv("KEKKAICURRENCY_TEST_EXPLAIN")
