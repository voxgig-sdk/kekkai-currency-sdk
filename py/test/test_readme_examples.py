# KekkaiCurrency SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions KekkaiCurrencySDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both KekkaiCurrencySDK(...) and KekkaiCurrencySDK.test(...) become
#      KekkaiCurrencySDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "kekkaicurrency_sdk"
_SDK_CLASS = "KekkaiCurrencySDK"
