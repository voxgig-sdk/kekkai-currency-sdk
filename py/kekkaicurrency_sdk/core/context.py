...
from kekkaicurrency_sdk.core.helpers import get_ctx_prop, to_map
...
class KekkaiCurrencyContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        # Ctrl
        self.ctrl = KekkaiCurrencyControl()
        ...
        if isinstance(sp, KekkaiCurrencySpec):
            self.spec = sp
        elif basectx is not None:
        ...
        if isinstance(r, KekkaiCurrencyResult):
            self.result = r
        elif basectx is not None:
        ...
        if isinstance(rp, KekkaiCurrencyResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def resolve_op(self, opname):
        ...
        if opname == "":
            return KekkaiCurrencyOperation({})
    ...
    def make_error(self, code, msg):
        return KekkaiCurrencyError(code, msg, self)
