...
from kekkaicurrency_sdk.utility import register

# Load features
from kekkaicurrency_sdk.feature.base_feature import KekkaiCurrencyBaseFeature
from kekkaicurrency_sdk.features import _has_feature, _make_feature
...
class KekkaiCurrencySDK:
    ...
    def __init__(self, options=None):
        ...
        utility = KekkaiCurrencyUtility()
        self._utility = utility

        from kekkaicurrency_sdk.config import shared_config
    ...
    def get_utility(self):
        return KekkaiCurrencyUtility.copy(self._utility)
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("KekkaiCurrencySDK: graphql: " + str(msg))
            res["graphql"] = errors
    ...
    def Chart(self, data=None) -> "ChartEntity":
        ...
        from kekkaicurrency_sdk.entity.chart_entity import ChartEntity
    ...
    def Currency(self, data=None) -> "CurrencyEntity":
        ...
        from kekkaicurrency_sdk.entity.currency_entity import CurrencyEntity
    ...
    def Metadata(self, data=None) -> "MetadataEntity":
        ...
        from kekkaicurrency_sdk.entity.metadata_entity import MetadataEntity
