# KekkaiCurrency Python SDK



The Python SDK for the KekkaiCurrency API — an entity-oriented client following Pythonic conventions.
...
release tag (`py/vX.Y.Z`, see [Releases](https://github.com/voxgig-sdk/kekkai-currency-sdk/releases)) or
...
```
py/
├── kekkaicurrency_sdk.py         -- Main SDK module
