...
The Python SDK for the KekkaiCurrency API. Provides an entity-oriented interface following Pythonic conventions.
...
result, err = client.KekkaiCurrency(None).load(
    {"id": "test01"}, None
)
