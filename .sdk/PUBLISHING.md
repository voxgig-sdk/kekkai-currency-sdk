...
|---|---|---|
| `ts/` | @voxgig-sdk/kekkai-currency-sdk | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/kekkai-currency-sdk \
      --repository voxgig-sdk/kekkai-currency-sdk \
      --file publish-ts.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/kekkai-currency-sdk` shows it, and
`npm trust revoke @voxgig-sdk/kekkai-currency-sdk --id=<id>` removes it.
