...
// KekkaiCurrency SDK pipeline test
//
...
{
    private static function utility(): KekkaiCurrencyUtility
    {
        return new KekkaiCurrencyUtility();
    }
    ...
    private static function ctx(array $over = []): KekkaiCurrencyContext
    {
        $utility = $over['utility'] ?? self::utility();
        $client = $over['client'] ?? new PlClient(['base' => 'http://h']);
        $ctx = new KekkaiCurrencyContext([
            'client' => $client,
            'utility' => $utility,
        ], null);
        $ctx->op = new KekkaiCurrencyOperation(['name' => 'load', 'entity' => 'x']);
        foreach ($over as $k => $v) {
    ...
    {
        return ($err instanceof KekkaiCurrencyError) ? $err->sdk_code : '';
    }
    ...
    public function test_make_point_rejects_a_disallowed_operation(): void
    {
        ...
        $ctx->op = new KekkaiCurrencyOperation(['name' => 'nope', 'entity' => 'x']);
        [$point, $err] = KekkaiCurrencyMakePoint::call($ctx);
    ...
    public function test_make_point_rejects_an_operation_with_no_endpoints(): void
    {
        ...
        $ctx->op = new KekkaiCurrencyOperation(['name' => 'load', 'entity' => 'x', 'points' => []]);
        [$point, $err] = KekkaiCurrencyMakePoint::call($ctx);
        $this->assertNull($point);
    ...
    public function test_make_point_returns_the_single_point(): void
    {
        ...
        $ctx = self::ctx(['options' => ['allow' => ['op' => 'load,list,create,update,remove']]]);
        $ctx->op = new KekkaiCurrencyOperation(['name' => 'load', 'entity' => 'x', 'points' => [$point]]);
        [$got, $err] = KekkaiCurrencyMakePoint::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new KekkaiCurrencySpec(['method' => 'GET']);
        $ctx = self::ctx();
        $ctx->out['spec'] = $preset;
        [$got, $err] = KekkaiCurrencyMakeSpec::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_response_guards_missing_spec_response_result(): void
    {
        $ctx = self::ctx([
            'spec' => null,
            'response' => new KekkaiCurrencyResponse([]),
            'result' => new KekkaiCurrencyResult([]),
        ]);
        [, $err] = KekkaiCurrencyMakeResponse::call($ctx);
        $this->assertSame('response_no_spec', self::code($err));

        $ctx = self::ctx([
            'spec' => new KekkaiCurrencySpec([]),
            'response' => null,
            'result' => new KekkaiCurrencyResult([]),
        ]);
        [, $err] = KekkaiCurrencyMakeResponse::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'spec' => new KekkaiCurrencySpec(['step' => 's']),
            'response' => new KekkaiCurrencyResponse(self::resp(404, null, ['x-a' => '1'])),
            'result' => new KekkaiCurrencyResult([]),
        ]);
        [, $err] = KekkaiCurrencyMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_2xx_parses_the_body_and_marks_ok(): void
    {
        $ctx = self::ctx([
            'spec' => new KekkaiCurrencySpec(['step' => 's']),
            'response' => new KekkaiCurrencyResponse(self::resp(200, ['v' => 1])),
            'result' => new KekkaiCurrencyResult([]),
        ]);
        [, $err] = KekkaiCurrencyMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_records_to_ctrl_explain_when_explain_is_on(): void
    {
        $ctx = self::ctx([
            'spec' => new KekkaiCurrencySpec(['step' => 's']),
            'response' => new KekkaiCurrencyResponse(self::resp(200, ['v' => 2])),
            'result' => new KekkaiCurrencyResult([]),
        ]);
        $ctx->ctrl->explain = ['on' => true];
        KekkaiCurrencyMakeResponse::call($ctx);
    ...
    {
        $preset = new KekkaiCurrencyResponse(self::resp(299));
        $ctx = self::ctx([
            'spec' => new KekkaiCurrencySpec([]),
            'response' => new KekkaiCurrencyResponse([]),
            'result' => new KekkaiCurrencyResult([]),
        ...
        [$got, $err] = KekkaiCurrencyMakeResponse::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null, 'result' => new KekkaiCurrencyResult([])]);
        [, $err] = KekkaiCurrencyMakeResult::call($ctx);
        $this->assertSame('result_no_spec', self::code($err));

        $ctx = self::ctx(['spec' => new KekkaiCurrencySpec([]), 'result' => null]);
        [, $err] = KekkaiCurrencyMakeResult::call($ctx);
    ...
    public function test_make_result_list_op_wraps_resdata_into_entity_instances(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new KekkaiCurrencySpec(['step' => 's']),
            'result' => new KekkaiCurrencyResult(['ok' => true, 'resdata' => [['a' => 1], ['a' => 2]]]),
        ]);
        $ctx->op = new KekkaiCurrencyOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = KekkaiCurrencyMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_result_empty_list_yields_empty_resdata(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new KekkaiCurrencySpec(['step' => 's']),
            'result' => new KekkaiCurrencyResult(['ok' => true, 'resdata' => []]),
        ]);
        $ctx->op = new KekkaiCurrencyOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = KekkaiCurrencyMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new KekkaiCurrencyResult(['ok' => true]);
        $ctx = self::ctx([
            'spec' => new KekkaiCurrencySpec([]),
            'result' => new KekkaiCurrencyResult([]),
        ]);
        $ctx->out['result'] = $preset;
        [$got, $err] = KekkaiCurrencyMakeResult::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_request_guards_a_missing_spec(): void
    {
        ...
        [, $err] = KekkaiCurrencyMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $boom = new KekkaiCurrencyError('boom', 'boom');
        $utility->fetcher = function (KekkaiCurrencyContext $_c, string $_u, array $_f) use ($boom): array {
            return [null, $boom];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new KekkaiCurrencySpec(['step' => 's', 'method' => 'GET', 'base' => 'http://h', 'parts' => ['a']]),
        ]);
        [$response, $err] = KekkaiCurrencyMakeRequest::call($ctx);
        $this->assertNull($err);
    ...
    {
        $utility = self::utility();
        $utility->fetcher = function (KekkaiCurrencyContext $_c, string $_u, array $_f): array {
            return [null, null];
        };
        $ctx = self::ctx([
            'utility' => $utility,
    ...
    public function test_make_request_a_normal_transport_response_is_wrapped(): void
    {
        ...
        [$response, $err] = KekkaiCurrencyMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertInstanceOf(KekkaiCurrencyResponse::class, $response);
    ...
    public function test_make_request_records_the_fetchdef_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->explain = ['on' => true];
        KekkaiCurrencyMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $utility->make_fetch_def = function (KekkaiCurrencyContext $c): array {
            return [null, $c->make_error('fetchdef_boom', 'boom')];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new KekkaiCurrencySpec(['step' => 's', 'method' => 'GET']),
        ]);
        [$response, $err] = KekkaiCurrencyMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertNotNull($response->err);
    ...
    {
        $preset = new KekkaiCurrencyResponse(self::resp(201));
        $ctx = self::ctx(['spec' => new KekkaiCurrencySpec([])]);
        $ctx->out['request'] = $preset;
        [$got, $err] = KekkaiCurrencyMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null]);
        [, $err] = KekkaiCurrencyMakeFetchDef::call($ctx);
    ...
    public function test_make_fetch_def_serialises_body_and_inits_missing_result(): void
    {
        ...
        [$fetchdef, $err] = KekkaiCurrencyMakeFetchDef::call($ctx);
        $this->assertNull($err);
    ...
    {
        $ctx = self::ctx(['result' => new KekkaiCurrencyResult(['ok' => true, 'resdata' => 42])]);
        $this->assertSame(42, KekkaiCurrencyDone::call($ctx));
    }

    public function test_done_raises_the_error_when_not_ok(): void
    {
        $ctx = self::ctx(['result' => new KekkaiCurrencyResult(['ok' => false])]);
        $this->expectException(KekkaiCurrencyError::class);
        KekkaiCurrencyDone::call($ctx);
    }

    public function test_make_error_returns_resdata_when_ctrl_throw_is_false(): void
    {
        $ctx = self::ctx(['result' => new KekkaiCurrencyResult(['ok' => false, 'resdata' => 'fallback'])]);
        $ctx->ctrl->throw_err = false;
        $this->assertSame('fallback', KekkaiCurrencyMakeError::call($ctx, null));
    }
    ...
    public function test_make_error_records_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->throw_err = false;
        $ctx->ctrl->explain = ['on' => true];
        KekkaiCurrencyMakeError::call($ctx, null);
    ...
    public function test_feature_add_appends_in_call_order(): void
    {
        ...
        $a = new KekkaiCurrencyBaseFeature();
        $b = new KekkaiCurrencyBaseFeature();
        KekkaiCurrencyFeatureAdd::call($ctx, $a);
        KekkaiCurrencyFeatureAdd::call($ctx, $b);
        $this->assertSame([$a, $b], $client->features);
    }

    private static function named_feature(string $name): KekkaiCurrencyBaseFeature
    {
        $f = new KekkaiCurrencyBaseFeature();
        $f->name = $name;
        return $f;
    }
    ...
    public function test_feature_add_ordering_before_after_replace(): void
    {
        ...
        KekkaiCurrencyFeatureAdd::call($ctx, $miss);
    ...
    private static function auth_ctx(array $options, ?array $headers): KekkaiCurrencyContext
    {
        $client = new PlClient($options);
        return self::ctx([
            'client' => $client,
            'spec' => $headers === null ? null : new KekkaiCurrencySpec(['headers' => $headers]),
        ]);
    }
    ...
    public function test_prepare_auth_guards_a_missing_spec(): void
    {
        ...
        [, $err] = KekkaiCurrencyPrepareAuth::call($ctx);
    ...
    public function test_prepare_auth_a_raw_apikey_goes_in_as_is(): void
    {
        ...
        KekkaiCurrencyPrepareAuth::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'response' => new KekkaiCurrencyResponse(['headers' => null]),
            'result' => new KekkaiCurrencyResult([]),
        ]);
        KekkaiCurrencyResultHeaders::call($ctx);
    ...
    public function test_result_body_skips_parsing_when_the_body_is_absent(): void
    {
        ...
        KekkaiCurrencyResultBody::call($ctx);
