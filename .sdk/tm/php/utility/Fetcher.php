...
// KekkaiCurrency SDK utility: fetcher

class KekkaiCurrencyFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; KekkaiCurrencySDK/1.0)';
    ...
    public static function call(KekkaiCurrencyContext $ctx, string $fullurl, array $fetchdef): array
    {
