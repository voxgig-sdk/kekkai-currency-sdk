...
// KekkaiCurrency SDK utility: transform_response

require_once __DIR__ . '/../core/Helpers.php';

class KekkaiCurrencyTransformResponse
{
    public static function call(KekkaiCurrencyContext $ctx): mixed
    {
        ...
        $transform = KekkaiCurrencyHelpers::to_map(\Voxgig\Struct\Struct::getprop($point, 'transform'));
        if (!$transform) {
            return null;
        }
