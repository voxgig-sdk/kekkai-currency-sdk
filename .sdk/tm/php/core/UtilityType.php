...
// KekkaiCurrency SDK utility type

class KekkaiCurrencyUtility
{
    ...
    public static function copy(KekkaiCurrencyUtility $src): KekkaiCurrencyUtility
    {
        $u = new KekkaiCurrencyUtility();
        $u->clean = $src->clean;
        $u->done = $src->done;
