...
// KekkaiCurrency SDK netsim feature
...
class KekkaiCurrencyNetsimFeature extends KekkaiCurrencyBaseFeature
{
    ...
    private function _simulate(KekkaiCurrencyContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(KekkaiCurrencyContext $ctx, array $applied): void
    {
        $client = $this->client;
