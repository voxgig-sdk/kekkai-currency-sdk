...
// KekkaiCurrency SDK streaming feature
...
class KekkaiCurrencyStreamingFeature extends KekkaiCurrencyBaseFeature
{
    ...
    private function _iterate(KekkaiCurrencyResult $result): \Generator
    {
    ...
    private function _streamable(KekkaiCurrencyContext $ctx): bool
    {
