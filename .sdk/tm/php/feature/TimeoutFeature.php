...
// KekkaiCurrency SDK timeout feature
...
class KekkaiCurrencyTimeoutFeature extends KekkaiCurrencyBaseFeature
{
    ...
    private function _with_timeout(KekkaiCurrencyContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(KekkaiCurrencyContext $_ctx, float $ms): void
    {
        $client = $this->client;
