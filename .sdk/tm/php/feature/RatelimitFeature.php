...
// KekkaiCurrency SDK ratelimit feature
...
class KekkaiCurrencyRatelimitFeature extends KekkaiCurrencyBaseFeature
{
    ...
    private function _acquire(KekkaiCurrencyContext $ctx): void
    {
    ...
    private function _track(KekkaiCurrencyContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
