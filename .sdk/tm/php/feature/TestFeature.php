...
// KekkaiCurrency SDK test feature

require_once __DIR__ . '/BaseFeature.php';
require_once __DIR__ . '/../utility/Param.php';

class KekkaiCurrencyTestFeature extends KekkaiCurrencyBaseFeature
{
    ...
    public function init(KekkaiCurrencyContext $ctx, array $options): void
    {
        ...
        $test_fetcher = function (KekkaiCurrencyContext $fctx, string $_fullurl, array $_fetchdef) use ($entity): array {
            ...
            if ($op->name === 'load') {
                ...
                $id = KekkaiCurrencyParam::call($fctx, 'id');
    ...
    public function makeNetsim(array $net, callable $inner): callable
    {
        ...
        return function (KekkaiCurrencyContext $fctx, string $url, array $fetchdef) use ($net, $inner, $pick_latency, $sleep): array {
            $this->_netcalls++;
            $call = $this->_netcalls;
     ...
     */
    public function buildArgs(KekkaiCurrencyContext $ctx, $op, $args): array
    {
        ...
        foreach ($keys as $k) {
            ...
            if ($is_id || $in_reqd) {
                $v = KekkaiCurrencyParam::call($ctx, $k);
