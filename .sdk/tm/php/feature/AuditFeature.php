...
// KekkaiCurrency SDK audit feature
...
class KekkaiCurrencyAuditFeature extends KekkaiCurrencyBaseFeature
{
    ...
    private function _emit(KekkaiCurrencyContext $ctx, string $outcome): void
    {
