...
// KekkaiCurrency SDK rbac feature
...
class KekkaiCurrencyRbacFeature extends KekkaiCurrencyBaseFeature
{
    ...
    private function _required(KekkaiCurrencyContext $ctx): ?string
    {
    ...
    private function _reject(KekkaiCurrencyContext $ctx, string $required): void
    {
    ...
    private function _track(KekkaiCurrencyContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
