...
The Ruby SDK for the KekkaiCurrency API. Provides an entity-oriented interface using idiomatic Ruby conventions.
...
result, err = client.KekkaiCurrency(nil).load(
  { "id" => "test01" }, nil
)
