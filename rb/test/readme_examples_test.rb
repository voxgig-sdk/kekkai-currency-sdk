...
#      offline in seeded test mode (KekkaiCurrencySDK.test) against the real
...
class ReadmeExamplesTest < Minitest::Test
  ...
  SDK = File.join(__dir__, "..", "KekkaiCurrency_sdk.rb")
  SDK_CLASS = "KekkaiCurrencySDK"
