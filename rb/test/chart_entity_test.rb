...
class ChartEntityTest < Minitest::Test
  ...
  def test_basic_flow
    ...
    if setup[:synthetic_only]
      skip "live entity test uses synthetic IDs from fixture — set KEKKAI_CURRENCY_TEST_CHART_ENTID JSON to run live"
      return
    end
    client = setup[:client]
...
def chart_basic_setup(extra)
  ...
  entid_env_raw = ENV["KEKKAI_CURRENCY_TEST_CHART_ENTID"]
